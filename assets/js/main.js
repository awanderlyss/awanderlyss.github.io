...
(function createRandomStars(){
  ...
  for(var i = 1;i<=64;i++){
    ...
    outterShape = setAttributes(outterShape,i,cx,cy,r+2,"#FFFAEA","url(#blur)");
...
(function lineDrawing(){
  ...
  easing: 'easeInSine',
  duration: 2300,
  delay: function(el, i) { return 3500 + i * 250 }
  // direction: 'alternate',
  // loop: true
});
})();
